...
describe('kolour', () => {
  ...
  [
    {argument: 'rgb(64, 92, 120)',                    expected: new Rgb(64, 92, 120)},
    {argument: 'rgba(64, 92, 120, 0.5)',              expected: new Rgb(64, 92, 120, 0.5)},
    {argument: 'rgba(20%, 40%, 60%, 0.5)',            expected: new Rgb(51, 102, 153, 0.5)},
    {argument: '#24D668',                             expected: new Rgb(36, 214, 104)},
    {argument: '#ABC',                                expected: new Rgb(170, 187, 204)},
    {argument: 'hsl(30, 50%, 25.4%)',                 expected: new Hsl(30, 0.5, 0.254)},
    {argument: 'hsla(30, 50%, 25.4%, 0.1)',           expected: new Hsl(30, 0.5, 0.254, 0.1)},
    {argument: 'hwb(30, 50%, 12.5%)',                 expected: new Hwb(30, 0.5, 0.125)},
    {argument: 'hwb(30, 50%, 12.5%, 0.1)',            expected: new Hwb(30, 0.5, 0.125, 0.1)},
    {argument: 'device-cmyk(80%, 0%, 51.4%, 16.1%)',  expected: new Cmyk(0.8, 0.0, 0.514, 0.161)},
  ].forEach((test) => {
